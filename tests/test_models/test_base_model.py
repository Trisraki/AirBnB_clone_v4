...
class TestBase(unittest.TestCase):
    ...
    def test_ids_differ(self):
        """Checks that ids between two instances are different."""
        new_model = BaseModel()
    ...
    def test_compare_dict(self):
        """Test the new_model's and my_model's
    ...
    def test_save(self):
        """Checks that after updating the instance; dates differ in the
